...
Page({
  ...
  onLoad: function(options) {
    ...
    this.setData({
      ...
      scope: app.loginInfoData.scope != 'store' ? true : false
    });
  ...
  // },
  changeGoodsSpec: function(e) {
    this.data.goodsInfo.spec = e.detail.value;
  },
  // 备注输入时触发
  ...
  changeIsDown: function(e) {
    if (e.detail.value) {
      this.data.goodsInfo.is_down = 0
    } else {
      this.data.goodsInfo.is_down = 1
    }
  ...
  delGoods: function() {
    ...
    app.netWork.postJson(app.urlConfig.delGoodsUrl, {
